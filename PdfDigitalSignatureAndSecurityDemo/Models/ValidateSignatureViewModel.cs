...
namespace PdfDigitalSignatureAndSecurityDemo.Models
{
    ...
    public class ValidateSignatureViewModel
    {
        ...
        /// <summary>Optional uploaded public certificates (root and intermediate) for signature validation.</summary>
        public IFormFileCollection? CertificateFiles { get; set; }
